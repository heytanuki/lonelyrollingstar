...
#define PRODUCT         Lonely Rolling Star
#define DESCRIPTION     Tiny choc ortho 
#define VIAL_KEYBOARD_UID {0x28, 0xF3, 0x0F, 0x04, 0x07, 0xFB, 0xDF, 0xEC}
...
#define MATRIX_COL_PINS { D1, D0, D4, C6, D7, E6, B4, B5, F6, F7 }
